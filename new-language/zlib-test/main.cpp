...
int main() {
    ...
    VAR(INCLUDES, "-IE:/nyu/senior/opensource/zlib/build -IE:/nyu/senior/opensource/zlib");
    VAR(CFLAGS, "-MD -O2");
    VAR(RC_FLAGS, "-D GCC_WINDRES -I E:/nyu/senior/opensource/zlib -I E:/nyu/senior/opensource/zlib/build");
    ...
    BUILD("zlib1rc.obj", "WINDRES_COMPILER", {"E:/nyu/senior/opensource/zlib/win32/zlib1.rc"});
    ...
    for (const auto& src : source_files) {
        ...
        std::string src_path = "E:/nyu/senior/opensource/zlib/" + src;
